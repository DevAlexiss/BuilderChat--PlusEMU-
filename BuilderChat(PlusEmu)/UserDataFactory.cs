...
namespace Plus.HabboHotel.Users.UserData
{
    public static class UserDataFactory
    {
        public static UserData GetUserData(string SessionTicket, out byte errorCode)
        {
            ...
            errorCode = 0;
            if (user.Rank >= 4)
            friends.Add(0x7fffffff, new MessengerBuddy(0x7fffffff, "Builder Chat", "hr-831-45.fa-1206-91.sh-290-1331.ha-3129-100.hd-180-2.cc-3039-73.ch-3215-92.lg-270-73", "Builder", 0, true, false));
